...
$(function() {
    ...
    //$(window).resize(function(){
        ...
        $('#passLandscape').change(function() {
            $('#pass').val($('#passLandscape').val());
        });

        $('#pass').change(function() {
            $('#passLandscape').val($('#pass').val());
        });

        $('.nameLandscape').change(function() {
            $('.name').val($('.nameLandscape').val());
        });

        $('.name').change(function() {
            $('.nameLandscape').val($('.name').val());
        });
